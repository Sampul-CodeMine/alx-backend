...
- <a href="https://redis.io/docs/latest/integrate/" target="_blank">Redis quick start</a>
- <a href="https://redis.io/docs/latest/develop/connect/cli/" target="_blank">Redis client interface</a>
- <a href="https://github.com/redis/node-redis" target="_blank">Redis client for Node JS</a>
- <a href="https://github.com/Automattic/kue" target="_blank">Kue</a> deprecated but still use in the industry
